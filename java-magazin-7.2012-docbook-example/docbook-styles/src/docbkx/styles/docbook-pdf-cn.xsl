  ...
  <xsl:template name="book.titlepage.recto">
	...
	<fo:table table-layout="fixed" width="100%">
	  ...
	  <fo:table-body>
	    <fo:table-row>
	      <fo:table-cell>
		<fo:block text-align="left" font-family="Calibri,Microsoft YaHei"
	      ...
	      <fo:table-cell>
		<fo:block text-align="right" font-family="Calibri,Microsoft YaHei"
			  color="#4f81bd" font-style="italic" font-size="12pt">
	...
	<fo:block-container height="90mm" padding-before="0mm"
	  ...
	  <fo:block font-family="Calibri,Microsoft YaHei" font-weight="bold"
	...
	<fo:block-container height="75mm" padding-before="10mm"
	  ...
	  <fo:block font-family="Calibri,Microsoft YaHei" font-size="22pt"
