...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match='xslthl:string' mode="xslthl">
		<fo:inline font-weight="normal" color="#2a00ff" font-style="italic">
			<xsl:apply-templates mode="xslthl" />
		</fo:inline>
	</xsl:template>
	...
	<xsl:template match='xslthl:tag' mode="xslthl">
		<fo:inline font-weight="normal" color="#3f7f7f">
			<xsl:apply-templates mode="xslthl" />
		</fo:inline>
	</xsl:template>
	...
	<xsl:template match='xslthl:value' mode="xslthl">
		<fo:inline font-weight="normal" color="#2a00ff">
			<xsl:apply-templates mode="xslthl" />
		</fo:inline>
	</xsl:template>
	...
	<xsl:template match='xslthl:doccomment|xslthl:doctype'
		mode="xslthl">
		<fo:inline font-weight="normal" color="#3f5fbf">
			<xsl:apply-templates mode="xslthl" />
		</fo:inline>
	</xsl:template>
