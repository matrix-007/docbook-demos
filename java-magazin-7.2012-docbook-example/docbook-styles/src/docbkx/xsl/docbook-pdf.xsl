...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:param name="body.font.family" select="'Times,SimSun'"/>

	<xsl:param name="title.font.family" select="'Arial,DroidSansFallback'"/>

	<xsl:param name="dingbat.font.family" select="'Arial,DroidSansFallback'"/>

	<xsl:param name="sans.font.family" select="'Arial,DroidSerif,DroidSansFallback'"/>
	...
	<xsl:attribute-set name="admonition.properties">
		<xsl:attribute name="font-family">'Arial','KaiTi'</xsl:attribute>
	...
	<xsl:attribute-set name="admonition.title.properties">
		<xsl:attribute name="font-family">'Arial','DroidSansFallback'</xsl:attribute>
		<xsl:attribute name="font-size">90%</xsl:attribute>
